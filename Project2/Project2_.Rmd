...
### Working Notes
Dueto the size of this data set the raw bulk data is not on github.For the sake of this analysis and excercise i will limit the accidents to one borough within NYC with the hopes of limiting the size. 
