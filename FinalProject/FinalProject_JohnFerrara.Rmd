...
- _Question 1_: Does the Number of Housing Related Construction Projects for the Previous 5 Years correlate with the Size of Adult Homeless Population?
    - *Null Hypothesis*: The number of housing related construction projects for the preceeding 5 year window period **does not** correlate with the adult homeless population.
    - *Alternative Hypothesis*: The number of housing related construction projects for the preceeding 5 year window period **does** coreelated with the adult homeless population.
...
MODEL 4 may not be valid. Redsiduals and Predicted values have a pattern in the points. The residuals have mostly normal distrubtion. Slight deviation, but normal.
...
Additionally, the adult homeless population data used in this analysis orginated at counts from the shelter system. This does not take into account the unhoused population that makes no use of the shelter system, so there may be a large blind spot not considered in this analysis. 

Lastly, several of the variables had floor effects on their distributions due to the nature of the variables. Log transformations were used, but there still were a large number of zero values for several of the variables examined. This analysis, other than logging the data, did not accomodate for this by removing outliers, weighing datapoints, or by other means. With this said, as shown by the model validitiy tests for linearity, some patterns are discernable. This may mean that these models are invalid and the conditions for linearity may not be met. The inclusion of these zero values and some outliers is another limitation of this analysios. Future work, should attempt to further clean and process the data so as to create more valid models.
